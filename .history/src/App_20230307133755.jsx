...
const App = () => {
  ...
  const [colorActual, setcolorActual] = useState('black')
  ...
  return (
    <>
      <div className="bg-dark fondo">
        <div className="col-12 contenedor-05 bg-danger">
        ...
        <div className="col-12 contenedor-06 bg-danger">
          <div className="contenedor-mayor header">
            <h2 className='bg-primary'>Pixel Art</h2>
            <h2 className='bg-primary'>Pixel Art</h2>
            <input type="color" value={colorActual}  onChange={(e) => { setcolorActual(e.target.value) }} />
          </div>
        </div>
      </div>
    </>
