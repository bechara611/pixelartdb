...
const App = () => {
  ...
  useEffect(() => {
    ...
    let divsAloAlto = Math.floor(contenedor.offsetHeight / 10)
    let divsAlOancho = Math.floor(contenedor.offsetWidth / 10);
      ...
      <div className="bg-dark fondo">
        <div className="col-12 contenedor-05 ">
          <div className="contenedor-mayor header">
            <h2 className='text-light'>Pixel Art</h2>
        ...
        <div className="col-12 contenedor-05  ">
          ...
          <i className="fa-solid fa-circle-down borrador iconoRedes" onClick={()=>{ 
            console.log('Descargar')
            }}></i>
          <i className="fa-solid fa-pencil borrador iconoRedes" onClick={()=>{ setLapiz(true)
            setcolorActual('#2233cc')
            }}></i>
            <i className="fa-solid fa-eraser borrador iconoRedes" onClick={()=>{ setLapiz(false)
            setcolorActual('transparent')
            }}></i>
       
            <i className="fa-solid fa-arrow-rotate-right iconoRedes  icono" onClick={() => { onReset() }}></i>
