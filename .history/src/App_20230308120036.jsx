...
const GenerarImagen=async()=>{
  let contenedor = document.getElementById('contorno');
  await htmlToImage.toPng(contenedor)
    ...
    <>
      <div className="bg-dark fondo">
        ...
        <div className="col-12 contenedor-05  ">
          ...
          <i className="fa-solid fa-circle-down borrador " onClick={()=>{ 
          ...
          <i className="fa-solid fa-pencil borrador" onClick={()=>{ setLapiz(true)
            ...
            <i className="fa-solid fa-arrow-rotate-right borrador  icono" onClick={() => { onReset() }}></i>
            <input type="color" className='selector borrador' value={colorActual} onChange={(e) => {
