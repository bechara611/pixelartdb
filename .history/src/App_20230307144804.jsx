      ...
      <div className="bg-dark fondo">
        ...
        <div className="contenedor-mayor ">
          <div className="contorno">
            <div className={`contenedor ${!lapiz ? 'cursorBorrador' : ''}`} id='contenedor'>
        ...
        <div className="col-12 contenedor-05  ">
          <div className="derecha mt-2">
            <i className="fa-solid fa-eraser borrador" onClick={()=>{ setLapiz(false)}}></i>
            <i className="fa-solid fa-arrow-rotate-right  icono" onClick={() => { onReset() }}></i>
            <input type="color" className='selector' value={colorActual} onChange={(e) => { setcolorActual(e.target.value) }} />
          </div>
        </div>
      </div>
    </>
